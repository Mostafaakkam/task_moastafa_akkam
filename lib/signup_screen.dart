  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Sign Up', style: textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w600)),
        centerTitle: true,
      ),
      body: SafeArea(
        child: LayoutBuilder(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _LabeledField(
                            ...
                            child: _PasswordField(controller: _confirmController),
                          ),
                          const SizedBox(height: 24),
                          SizedBox(
